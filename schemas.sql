...
INSERT INTO tbl_rateclass(type) values 
('Daily'),
('Monthly');
...
-- Positions
INSERT INTO tbl_positions (department_id, rateclass_id, name, details, salary_rate) VALUES
(1, 1, 'Chef', 'Head of the kitchen, responsible for menu creation and food quality', 450.00),
(1, 1, 'Sous Chef', 'Assists the head chef in kitchen operations', 450.00),
(1, 1, 'Cook', 'Responsible for cooking and food preparation', 450.00),
(2, 1, 'Waiter/Waitress', 'Responsible for taking orders and serving food to customers', 450.00),
(3, 2, 'Restaurant Manager', 'Oversees overall restaurant operations and staff management', 12000.00);

-- Employees
INSERT INTO tbl_employees (position_id, gender_id, civil_id, emp_fname, emp_lname, emp_mname, birthdate, email, sss_no, philhealth_no, pagibig_no, date_hired, status, emp_type) VALUES
(1, 1, 2, 'Juan', 'Dela Cruz', 'Santos', '1990-05-15', 'juan@example.com', '123456789', '123-456789-00', '123456789000', '2023-01-15', 'Active', 1),
(4, 2, 1, 'Maria', 'Santos', 'Reyes', '1995-08-20', 'maria@example.com', '987654321', '987-654321-00', '987654321000', '2023-02-20', 'Active', 1),
(4, 2, 1, 'Pedro', 'Garcia', 'Ramos', '1992-11-10', 'pedro@example.com', '456123789', '456-123789-00', '456123789000', '2023-03-10', 'Active', 1),
(5, 1, 3, 'Ana', 'Reyes', 'Lopez', '1988-03-25', 'ana@example.com', '654987321', '654-987321-00', '654987321000', '2023-04-05', 'Active', 1);
